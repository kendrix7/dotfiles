...
echo "  redis-up         - Jump to ~/code/work/docker-compose/Redis && docker-compose up -d"
echo "  redis-down         - Jump to ~/code/work/docker-compose/Redis && docker-compose down"
echo "  postgres-up         - Jump to ~/code/work/docker-compose/Postgres && docker-compose up -d"
echo "  postgres-down         - Jump to ~/code/work/docker-compose/Postgres && docker-compose down"
echo "  kafka-up         - Jump to ~/code/work/docker-compose/Kafka && docker-compose up -d"
echo "  kafka-down         - Jump to ~/code/work/docker-compose/Kafka && docker-compose down"
echo "  token-local         - Jump to ~/code/work/cdp-behind-service && ./bin/admin token --env local"
echo "  token-dev         - Jump to ~/code/work/cdp-behind-service && ./bin/admin token --env dev"
echo "  token-stage         - Jump to ~/code/work/cdp-behind-service && ./bin/admin token --env stage"
echo "  token-prod         - Jump to ~/code/work/cdp-behind-service && ./bin/admin token --env prod"
echo ""
echo "🔀 GIT SHORTCUTS:"
echo "  gs    - git status"
echo "  ga    - git add"
